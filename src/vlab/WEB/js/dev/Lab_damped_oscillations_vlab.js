function init_lab() {
    ...
    var lab_animation_data = [];
    var THREAD_LENGTH = 140;
    var CARGO_HEIGHT = 30;
    var FREE_ENDING = 8;
    var pendulum_radius;
    var experiment_time = 8;
    var table_experiments_rows = 1;
    var help_active = false;
    var graphics_active = false;
    var default_var = {
        "radius_bounds": [3, 6],
        "mass": 1
    };
    ...
    var mass;
    var lab_var;
    var length_coefficient;
    var btn_stop_blocked = true;
    var btn_launch_blocked = false;
